#include "listaFornecedores.hpp"



void ListaFornecedoresViews::handleRequest(Poco::Net::HTTPServerRequest& request, Poco::Net::HTTPServerResponse& response) {
...
void ListaFornecedoresViews::Get(Poco::Net::HTTPServerResponse& response){
    try{
